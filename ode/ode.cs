...
class ode{
	public static int Main(){
		...
		double N = 5.8; double T_c = 0; double T_r = 14.0; // Model parameters
		...
		for(T_c=0.25;T_c<2;T_c+=0.5){
			sir_res = ode_solver.rk12(sir_ODE, ya, a, b);
			var sir_out = new System.IO.StreamWriter($"sir_out_T_c_{T_c}.txt",append:false);
