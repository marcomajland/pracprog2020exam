...
class ode{
	public static int Main(){
		...
		double acc = 1e-4; double eps = 1e-4; double h = 0.01; int max_steps = 5000;
		Tuple<List<double>, List<vector>> cos_res = ode_solver.solve(cos_ODE, ya, a, b, acc, eps, h, max_steps,"rk12");
